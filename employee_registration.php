<?php
    ...
    if($_SERVER["REQUEST_METHOD"]=="POST") {
        ...
        if(isset($_POST["savebtn"])){
            ...
            $sql = "INSERT INTO personal_infotbl (employee_no, fname, mname, lname, suffix, birth_date,
            gender, nationality, civil_status, department, designation, qualified_dep
            endent_status, employee_status, pay_date, contact_no, email_address,
            other_social_medica_account, social_media_account_id, address_line1,
            address_line2, municipality, state_province, country, zip_code, picpath)
            VALUES ('$employee_number', '$fname', '$mname', '$lname', '$suffix', '$birth_date',
            '$gender', '$nationality', '$civil_status', '$department', '$designation,
            '$qualified_dependent_status', '$employee_status', '$pay_date',
            '$contact_no', '$email_address', '$other_social_medica_account',
            '$social_media_account_id', '$address_line1', '$address_line2',
            '$municipality', '$state_province', '$country', '$zip_code', '$picpath')";
...
<head>
    ...
    <link rel="stylesheet" href="newtempstyle.css">
</head>
<body>
    <div class="flex_container_row">
        <form id="employee_registration_save" class="a-form" action="employee_registration_save.php" method="post" width="840">
            <div class="flex_container_row">
                <div class="flex_container_column">
                    <div>
                        <img src="https://i.imgur.com/UL4IXoX.png" alt="Casan's Footwear Logo" width="400">
                    </div>
                    <div class="subform">
                        <form id="pic-upload" class="a-form" enctype="multipart/form-data" method="post" width="840">
                            <div>
                                <h2 class="mb-0 font-weight-bold">PERSONAL INFO</h2>
                        ...
                        <input type="date" class="form-control mt-0" name="birth_date" id="bday">
                ...
                <div class="flex_container_column">
                    <div class="subform">
                        ...
                        <select class="form-control" name="qualified_dependent_status"
                            id="qualified_dependent_status">
                            <option value=''>-- select one --</option>
                    ...
                    <div class="subform">
                        <h2 class="mb-0 font-weight-bold">CONTACT INFO</h2>   
                    ...
                    <div class="subform">
                        <h2 class="mb-0 font-weight-bold">ADDRESS</h2>
                    ...
                    <div class="flex_container_row">
                        <button id="registration_button" type="submit" class="btn btn-primary" name="savebtn">SAVE</button>
                        <button id="registration_button" type="reset" class="btn btn-outline-secondary" name="cancelbtn">CANCEL</button>
                    </div>
                </div>
            </div>
        </form>
        ...
        $('#uploadfile').change(function(e) {
            ...
            $.ajax({
                ...
                success: function(result) {
                    if (result.ok) {
                        $('#pic-box').html('');
                        $('#pic-box').append("<img src='" + result.temp_path +
                            "' style='width:100%'/>");
