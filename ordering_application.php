...
use LDAP\Result;
        ...
        <form action="" method="post" >
            <div class="flex_container_row">
                <div>
                    <div class="title">
                        <img src="https://i.imgur.com/nd7JLkm.png" alt="Casan's Footwear Logo" width="400">
                    </div>
                ...
                <div class="flex_container_column" style="margin-left:40px;">
                    ...
                    <div class="flex_container_row" id="ordering_app_buttons">
                        <!-- BUTTONS -->
